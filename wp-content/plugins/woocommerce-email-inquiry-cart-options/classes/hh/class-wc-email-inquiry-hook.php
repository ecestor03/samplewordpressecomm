...
class WC_Email_Inquiry_Hook_Filter
{
	...
	public static function add_email_inquiry_button($product_id) {
		...
		if (trim($wc_email_inquiry_button_title) == '') $wc_email_inquiry_button_title = __('Product Inquiry', 'wc_email_inquiry');
...
<div style="padding:10px;">
	<h1 class="wc_email_inquiry_result_heading"> Inquiry	</h1>
	
	<div class="wc_email_inquiry_content" id="wc_email_inquiry_content_<?php echo $product_id; ?>">
		<p>We are HAPPY to hear from you by filling out this survey form.</p>
		...
		<div class="wc_email_inquiry_field">
			<p class="wc_email_inquiry_subject">Quantity (in pieces for individual products and number of PAKs)</p>
        	<label class="wc_email_inquiry_label" for="quantity_<?php echo $product_id; ?>"><?php _e('Quantity','wc_email_inquiry'); ?> <span class="wc_email_inquiry_required">*</span></label>
			<input type="text" class="quantity" name="your_qty" id="quantity<?php echo $product_id; ?>" value="" /></div>	
		<div class="wc_email_inquiry_field">
